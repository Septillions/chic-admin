      ...
      <el-dropdown
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item command="left">
            <icon name="arrow-left" class="base-mr-10"/>
            关闭左侧
          </el-dropdown-item>
          <el-dropdown-item command="right">
            <icon name="arrow-right" class="base-mr-10"/>
            关闭右侧
          </el-dropdown-item>
          <el-dropdown-item command="other">
            <icon name="times" class="base-mr-10"/>
            关闭其它
          </el-dropdown-item>
          <el-dropdown-item command="all">
            <icon name="times-circle" class="base-mr-10"/>
            全部关闭
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
...
export default {
  components: {
    ...
    ContextmenuList: () => import('../contextmenu/components/contentmenu-list')
  },
  data () {
    return {
      ...
      contextmenuList: [
        { icon: 'refresh', title: '刷新页面', value: 'refresh' },
